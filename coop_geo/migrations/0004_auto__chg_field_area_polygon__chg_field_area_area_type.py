...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('coop_geo_area', 'polygon', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True))

        # Changing field 'Area.area_type'
        db.alter_column('coop_geo_area', 'area_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['coop_geo.AreaType']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Area.polygon'
        raise RuntimeError("Cannot reverse this migration. 'Area.polygon' and its values cannot be restored.")

        # Changing field 'Area.area_type'
        db.alter_column('coop_geo_area', 'area_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_geo.AreaType'], null=True))
