...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('coop_geo_area_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('area', models.ForeignKey(orm['coop_geo.area'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('coop_geo_area_sites', ['area_id', 'site_id'])

        # Adding M2M table for field sites on 'Location'
        db.create_table('coop_geo_location_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('location', models.ForeignKey(orm['coop_geo.location'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('coop_geo_location_sites', ['location_id', 'site_id'])


    def backwards(self, orm):
        # Removing M2M table for field sites on 'Area'
        db.delete_table('coop_geo_area_sites')

        # Removing M2M table for field sites on 'Location'
        db.delete_table('coop_geo_location_sites')
