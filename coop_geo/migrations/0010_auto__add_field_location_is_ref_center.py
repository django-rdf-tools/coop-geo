...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.is_ref_center'
        db.add_column('coop_geo_location', 'is_ref_center',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.is_ref_center'
        db.delete_column('coop_geo_location', 'is_ref_center')
    ...
    models = {
        ...
        'coop_geo.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'gSrsdRwdDMTPpPVbg7P75h'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        'coop_geo.arealink': {
        ...
        'coop_geo.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'RMwi7v8gKrx26HC9Pvaxqg'", 'max_length': '50', 'unique': 'True', 'null': 'True'}),
